...
def collect_data():
    ...
    for post_box in post_boxes:
        ...
        readmd_posts.append([title, banner_link])
    ...
    print(f"[READ]  {'Файл README.md обновлен' if update_readme(readmd_posts[0][0], readmd_posts[0][1]) else 'Не удалось обновить файл README.md'}")
